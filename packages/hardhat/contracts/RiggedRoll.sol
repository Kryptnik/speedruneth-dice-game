...
error RiggedRoll__NotRigthTime();
    ...
    // Include the `receive()` function to enable the contract to receive incoming Ether. This will allow us to fund the RiggedRoll
    // contract from the faucet which is required for our contract to call the rollTheDice() function.
